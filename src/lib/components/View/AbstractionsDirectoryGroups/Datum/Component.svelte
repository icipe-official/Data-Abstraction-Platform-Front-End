<script lang="ts">
	...
	const COMPONENT_NAME = 'view-abstractions-directory-groups-datum'
...
{:else}
	...
	>
		...
		<main class="flex flex-col gap-y-4 overflow-auto">
			{@render datumabstractiongroupdescription()}
...
{#snippet datumabstractiongroupdescription()}
	{@const fieldData = getDatumFieldData(
...
{#snippet datumlastupdatedon()}
	{@const fieldData = getDatumFieldData(
		Domain.Entities.AbstractionsDirectoryGroups.RepositoryName,
		Domain.Entities.AbstractionsDirectoryGroups.FieldColumn.LastUpdatedOn,
		joindepth
	)}
...
{#snippet datumcreatedon()}
	{@const fieldData = getDatumFieldData(
		Domain.Entities.AbstractionsDirectoryGroups.RepositoryName,
		Domain.Entities.AbstractionsDirectoryGroups.FieldColumn.CreatedOn,
		joindepth
	)}
...
{#snippet datumdeactivatedon()}
	{@const fieldData = getDatumFieldData(
		Domain.Entities.AbstractionsDirectoryGroups.RepositoryName,
		Domain.Entities.AbstractionsDirectoryGroups.FieldColumn.DeactivatedOn,
		joindepth
	)}
