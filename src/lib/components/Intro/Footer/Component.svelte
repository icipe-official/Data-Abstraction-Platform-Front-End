...
<div class="flex min-h-fit h-fit justify-between gap-x-1 overflow-x-auto rounded-lg bg-white p-2">
	...
	<img src={Domain.Entities.Static.MAP_LOGO_PNG} alt="malaria atlas logo" class="max-h-[5vh] max-w-[10vw] self-center" />
	<img src={Domain.Entities.Static.B_AND_A_LOGO_PNG} alt="bill and melinda gates foundation logo" class="max-h-[5vh] max-w-[10vw] self-center" />
</div>
